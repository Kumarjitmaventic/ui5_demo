		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demodemandresourcedemand-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demodemandresourcedemand-display": {
								"semanticObject": "demodemandresourcedemand",
								"action": "display",
								"description": "A Demo Resource demand application",
								"title": "Resource Demand",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.demand.resourcedemand",
									"url": sap.ui.require.toUrl("demo/demand/resourcedemand")
								}
							}
						}
					}
