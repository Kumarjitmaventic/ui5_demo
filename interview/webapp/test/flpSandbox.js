		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demointerviewinterview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demointerviewinterview-display": {
								"semanticObject": "demointerviewinterview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.interview.interview",
									"url": sap.ui.require.toUrl("demo/interview/interview")
								}
							}
						}
					}
