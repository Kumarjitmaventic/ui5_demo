		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demotechnicallisttechnicalinterview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demotechnicallisttechnicalinterview-display": {
								"semanticObject": "demotechnicallisttechnicalinterview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demo.technical.list.technicalinterview",
									"url": sap.ui.require.toUrl("demo/technical/list/technicalinterview")
								}
							}
						}
					}
